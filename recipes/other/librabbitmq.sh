...
PKG_CMAKE_FLAGS="-DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DBUILD_STATIC_LIBS=ON -DINSTALL_STATIC_LIBS=ON -DBUILD_TOOLS=OFF -DBUILD_EXAMPLES=OFF -DENABLE_SSL_SUPPORT=OFF -DRUN_SYSTEM_TESTS=OFF"
